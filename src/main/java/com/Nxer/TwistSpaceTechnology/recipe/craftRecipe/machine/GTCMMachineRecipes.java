...
public class GTCMMachineRecipes implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .metadata(SCANNING, new Scanning(1 * HOURS, 30))
            .itemInputs(
                ItemList.Casing_Advanced_Iridium.get(1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .metadata(SCANNING, new Scanning(2 * HOURS, 30))
            .itemInputs(
                ItemList.Casing_Advanced_Iridium.get(1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .metadata(SCANNING, new Scanning(24 * HOURS, 30))
            .itemInputs(
        ...
        GTValues.RA
            ...
            .metadata(SCANNING, new Scanning(16 * HOURS, 30))
            .itemInputs(
                GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.CosmicNeutronium, 64),
        ...
        GTValues.RA
            ...
            .metadata(SCANNING, new Scanning(640 * HOURS, 30))
            .itemInputs(
                UXVTarget104.get(64),
        ...
        // region Astral Array
        {
            GTValues.RA
                ...
                .metadata(SCANNING, new Scanning(114514 * 20, 30))
                .itemInputs(
            ...
            GTValues.RA
                ...
                .metadata(SCANNING, new Scanning(720000, 30))
                .itemInputs(
