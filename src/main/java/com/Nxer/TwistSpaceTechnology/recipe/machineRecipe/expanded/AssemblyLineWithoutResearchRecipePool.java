    ...
    public void loadSpecialRecipes() {
...

        {
            ...
            TST_RecipeBuilder.builder()
                ...
                .itemOutputs(GTUtility.copyAmountUnsafe(8192, new ItemStack(IGItems.DysonSwarmItems, 1)))
                .eut(100000000)
                .duration(20 * 50)
                .addTo(MASL);
        }
                ...
                for (int absoluteTier = 0; absoluteTier < 9; absoluteTier++) {
                    GTValues.RA.stdBuilder()
                        .itemInputs(
                            ...
                            new ItemStack(IGBlocks.DysonSwarmCasing, (absoluteTier + 1) * 4, 2),
                            new ItemStack(IGBlocks.DysonSwarmCasing, (absoluteTier + 1) * 4, 1),
                ...
                for (int absoluteTier = 0; absoluteTier < 9; absoluteTier++) {
                    GTValues.RA.stdBuilder()
                        .itemInputs(
                            ...
                            baseCasing,
                            // Dyson Swarm Module.
                            new ItemStack(IGItems.DysonSwarmItems, 4 * (absoluteTier + 1)),
